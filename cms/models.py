...
class CmsSlider (models.Model):
    ...
    def __str__(self):
        return self.cms_title  # заменить название эелемента на имя из элемента

    class Meta:
        verbose_name = 'Слайд'
        verbose_name_plural = 'Слайды'  # меняем ордер на заказ и плюрал это множеметвенное число
